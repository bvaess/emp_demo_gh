...
@@application/shared_components/navigation/lists/references.sql
@@application/shared_components/files/app_icon_svg.sql
@@application/shared_components/files/app_icon_css.sql
@@application/shared_components/files/employees_jpg.sql
@@application/shared_components/files/logo_jpg.sql
...
@@application/shared_components/user_interface/lovs/lov_department_by_description.sql
@@application/shared_components/user_interface/lovs/lov_department_by_id.sql
@@application/shared_components/user_interface/lovs/lov_department_by_name.sql
